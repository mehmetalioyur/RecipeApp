...
object Dependencies {
    ...
    object Deps {
        ...
        // ESKİ: val hiltLifecycleViewModel by lazy { "androidx.hilt:hilt-lifecycle-viewmodel:${Versions.hiltLifecycleVersion}" }
        // YENİ:
        val hiltNavigationFragment by lazy { "androidx.hilt:hilt-navigation-fragment:${Versions.hiltNavigationFragmentVersion}" }
        ...
        val okHttpLoggingInterceptor by lazy { "com.squareup.okhttp3:logging-interceptor:${Versions.okHttpVersion}" }
